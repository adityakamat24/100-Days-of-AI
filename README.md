...
* **One notebook per day.** Copy only today’s block into a fresh Colab, save as `dayXX.ipynb`, run top‑to‑bottom.
* **Commit daily.** Keep a public GitHub repo with the notebook and a brief line in `README.md`:  
  `Day 7 ✅ – Monte‑Carlo π approximated`.
* **Reserve Fridays.** Every 7th day is a “mini‑project” that may need ~2 h—or split across Sat/Sun.
* **Proof of work.** Each day ends with what to push or share.
* **Level‑up.** Optional stretch goal if you have time.

---

## Phase 1 — Groundwork (Days 1‑14)
*(Detailed earlier; unchanged)*
